                    ...
                    for(c=0;c<todas_livrarias.size();c++) {
                        if(todas_livrarias.get(c).getNome_livraria().equals(pergunta)) {
                            ...
                            for(a=0;a<todos_livros.size();a++) {
                                System.out.println("Título: "+todos_livros.get(a).titulo_livro+" -> Autor: "+todos_livros.get(a).autor_livro+" -> Editora: "+todos_livros.get(a).editora_livro+" -> Ano: "+todos_livros.get(a).ano_livro);
                            }
                            break;
                        }
                    }
                    ...
                    for(c=0;c<todas_livrarias.size();c++) {
                        if(todas_livrarias.get(c).getNome_livraria().equals(pergunta)) {
                            ...
                            for(a=0;a<todos_funcionarios.size();a++) {
                                System.out.println("Funcionário: "+todos_funcionarios.get(a).nome_funcionario);
                            }
                            break;
                        }
                    }
